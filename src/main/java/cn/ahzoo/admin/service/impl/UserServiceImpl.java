...
import cn.ahzoo.admin.mapper.SysUserMapper;
...
public class UserServiceImpl extends ServiceImpl<SysUserMapper, User>
    ...
    public Result<?> resetPassword(UserDTO userDTO) {
        if (StringUtils.isEmpty(userDTO.getPassword())) {
            return Result.failed(ResultCode.INVALID_PARAM.getCode(), "密码不能为空");
        }
        ...
        String digestPassword = digester.digestHex(userDTO.getPassword() + salt);
